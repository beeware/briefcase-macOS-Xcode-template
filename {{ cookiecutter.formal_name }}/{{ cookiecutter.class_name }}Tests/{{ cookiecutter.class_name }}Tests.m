...
- (void)setUp {
    ...
    tests_path = [NSString stringWithFormat:@"%@/{{ cookiecutter.class_name }}Tests.xctest/Contents/Resources/tests", pluginsPath, nil];
    NSLog(@"Tests path: %@", tests_path);

    test_packages_path = [NSString stringWithFormat:@"%@/{{ cookiecutter.class_name }}Tests.xctest/Contents/Resources/test_packages", pluginsPath, nil];
