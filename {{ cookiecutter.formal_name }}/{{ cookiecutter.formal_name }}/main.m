...
int main(int argc, char *argv[]) {
    ...
    @autoreleasepool {
        ...
        // path = [NSString stringWithFormat:@"%@/Support/Python/Resources/lib/python38.zip", resourcePath, nil];
        // NSLog(@"- %@", path);
        ...
        path = [NSString stringWithFormat:@"%@/Support/Python/Resources/lib/python3.8", resourcePath, nil];
        NSLog(@"- %@", path);
        wtmp_str = Py_DecodeLocale([path UTF8String], NULL);
        status = PyWideStringList_Append(&config.module_search_paths, wtmp_str);
        if (PyStatus_Exception(status)) {
        ...
        // path = [NSString stringWithFormat:@"%@/Support/Python/Resources/lib/python3.8/lib-dynload", resourcePath, nil];
        // NSLog(@"- %@", path);
        // wtmp_str = Py_DecodeLocale([path UTF8String], NULL);
        // status = PyWideStringList_Append(&config.module_search_paths, wtmp_str);
        // if (PyStatus_Exception(status)) {
